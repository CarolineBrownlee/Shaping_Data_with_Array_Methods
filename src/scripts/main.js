...
// You have been tasked with building a list of email addresses of all of our customer's 
// contacts so we can spam them with an email about Miffles the Vampire Weiner Dog.
...
//   maps over the customers array, 
const spam = customers.map(customer => {
    // and for each customer returns their contacts object in a new array
    return customer.contacts
})
// the new array
console.log(spam)

// maps over the new array from above (spam array)
const spam2 = spam.map(contact => {
    // and returns just the email array on contacts object stored in the spam array
    return contact.email
})
// the new array of emails (spam2) from the new array of contacts (spam)
console.log(spam2)